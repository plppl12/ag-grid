...
export const chromeColorScheme = new Scheme('chromeColorScheme', [
  ...
  },
  {
    ...
    variables: {
      ...
      '--ag-subheader-background-color': Color.parseCss('#eee'),
      '--ag-subheader-toolbar-background-color': Color.parseCss('rgba(238, 238, 238, 0.5)'),
      '--ag-header-cell-hover-background-color': Color.parseCss('#f2f2f2'),
      '--ag-chip-background-color': Color.parseCss('#e2e2e2'),
      '--ag-row-hover-color': Color.parseCss('#fafafa'),
      '--ag-column-hover-color': Color.parseCss('#fafafa'),
